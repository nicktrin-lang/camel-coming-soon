...
function CustomerResetPasswordInner() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setSuccess(true);
      setTimeout(() => router.replace("/test-booking/login"), 2500);
    } catch (e: any) {
      ...
      <div className="rounded-3xl border border-black/5 bg-white p-8 shadow-[0_18px_45px_rgba(0,0,0,0.08)]">
        {sessionError ? (
          <>
            ...
            <a href="/test-booking/login" className="mt-6 inline-block rounded-full bg-[#ff7a00] px-6 py-3 font-semibold text-white shadow-[0_8px_18px_rgba(0,0,0,0.18)] hover:opacity-95">Back to login</a>
          </>
        ) : success ? (
          <>
