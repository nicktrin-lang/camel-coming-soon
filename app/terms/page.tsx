    ...
    <div className="w-full">
      ...
      <section className="w-full bg-gradient-to-br from-[#003768] to-[#005b9f] px-6 py-16 text-white">
        <div className="mx-auto max-w-4xl">
          ...
          <h1 className="mb-3 text-4xl font-bold">Customer Terms of Use</h1>
      ...
      <section className="w-full bg-white px-6 py-16">
        <div className="mx-auto max-w-4xl space-y-8 text-[#475569] leading-relaxed">
          ...
          <div>
            <h2 className="text-xl font-bold text-[#003768] mb-3">2. What Camel Global actually is</h2>
            <p className="mb-3">
              This is important, so we want to be upfront about it: <strong>Camel Global is a platform intermediary,
              not a car hire company.</strong>
            </p>
            <p className="mb-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-[#003768] mb-3">3. Creating an account</h2>
            <p className="mb-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-[#003768] mb-3">4. Making a booking</h2>
            <p className="mb-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-[#003768] mb-3">5. Fuel charges</h2>
            <p className="mb-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-[#003768] mb-3">6. Payments</h2>
            <p className="mb-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-[#003768] mb-3">7. Cancellations</h2>
            <p className="mb-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-[#003768] mb-3">8. Insurance and your responsibilities</h2>
            <p className="mb-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-[#003768] mb-3">9. Our liability</h2>
            <p className="mb-3">
              Camel Global is a platform intermediary. We are responsible for:
            </p>
          ...
          <div>
            <h2 className="text-xl font-bold text-[#003768] mb-3">12. Changes to these terms</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold text-[#003768] mb-3">13. Governing law</h2>
            <p>
